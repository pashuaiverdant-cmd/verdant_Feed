    ...
    <div className="min-h-screen bg-background font-sans">
            ...
            <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 rounded-2xl border border-white/15 bg-white/10 p-6">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-2xl md:text-3xl font-bold font-sans">{s.value}</div>
                  <div className="text-sm text-primary-foreground/80 font-sans">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container-custom space-y-10">
          {timeline.map((t, i) => (
            <div key={i}>
              <p className="text-primary font-semibold font-sans">{t.year}</p>
              <h3 className="text-xl font-serif font-semibold tracking-tight">{t.title}</h3>
              <p className="text-muted-foreground font-sans">{t.desc}</p>
            </div>
          ))}
        </div>
      </section>
